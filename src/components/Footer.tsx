    ...
    <footer className="bg-[#1a1a1a] text-gray-300">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex justify-center gap-5 mb-8">
          {socials.map(({ href, Icon, label }) => (
            <a
              ...
              aria-label={label}
              className="w-11 h-11 rounded-full border border-gray-600 flex items-center justify-center text-gray-400 hover:text-white hover:border-white transition-colors"
            >
              <Icon />
            </a>
          ))}
        ...
        <p className="text-center text-sm text-gray-500">
          Bastille Hotel © {year} Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
